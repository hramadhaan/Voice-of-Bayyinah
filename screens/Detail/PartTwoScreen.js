    ...
    return (
      <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
        <Text
          ...
          Part 2 belum tersedia saat ini
        </Text>
      </View>
    );
  }
...
PartTwoScreen.navigationOptions = (navData) => {
  return {
    title: 'Part II',
  };
};

export default PartTwoScreen;
